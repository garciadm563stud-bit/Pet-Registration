...
<head>
    ...
    .header-wrapper {
        ...
        margin-bottom: 10px;
        padding-bottom: 6px;
        border-bottom: 2px solid #2E7D32; /* GREEN */
    }
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="value">{{ $owner->address ?? '__________' }}</div>
                            </td>
        ...
        <table class="info-table">
            <tr>
                ...
                <td>
                    ...
                    <div class="name">{{ $pet->pet_name ?? '__________' }}</div>
    ...
    : '__________' }}
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="value">{{ $pet->color ?? '__________' }}</div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="value">
                                    {{ $pet->birth_date
    ? \Carbon\Carbon::parse($pet->birth_date)->format('Y-m-d')
    : '__________' }}
                                </div>
                            </td>
